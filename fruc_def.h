...
vector updateSet[] = {{-3,-1},{-3,0},{-3,1},{-3,2},	// update set
						{-2,-2},{-2,-1},{-2,0},{-2,1},{-2,2},						
						{-1,-2},{-1,-1},{-1,0},{-1,1},{-1,2},	// for x axis (-3,-1,0,1,3)
						{0,-2},{0,-1},{0,1},{0,2},		// for y axis (-2,-1,0,1,2)
						{1,-2},{1,-1},{1,0},{1,1},{1,2},		// assumed that motion is higher likely
						{2,-2},{2,-1},{2,0},{2,1},{2,2},						
						{3,-1},{3,0},{3,1},{3,2}};	// in the x direction
...
int L1_MedianFilter(vector*,int);
void Spiral(int,int);
#endif